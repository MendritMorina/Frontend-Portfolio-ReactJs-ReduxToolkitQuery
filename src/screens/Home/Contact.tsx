    ...
    <div className='pt-8'>
      ...
      <div className='flex gap-20 sm:flex-wrap sm:gap-10 sm:flex-col-reverse'>
        <div className='flex flex-col'>
          <p className='text-white text-2xl sm:hidden'>Have an exciting project you need help with? Fill the form or
            contact me via instant message!</p>
            <a href="mailto:mendritmorina4@gmail.com" className='flex items-center text-white hover:text-tertiary hover:text-2xl hover:font-semibold mt-12 sm:mt-1'><MdEmail className="mr-2"/>
          ...
          <p className='flex items-center text-white hover:text-tertiary hover:text-2xl hover:font-semibold mt-2'>
            ...
            <a href="https://www.linkedin.com/in/mendrit-morina-9aa946215" className='flex items-center text-white hover:text-tertiary hover:text-2xl hover:font-semibold mt-2' target="_blank">
              <FaLinkedin className="mr-2"/>
            LinkedIn
            </a>
            <a href="https://www.instagram.com/mendritmorina_" className='flex items-center text-white hover:text-tertiary hover:text-2xl hover:font-semibold mt-2' target="_blank">
              <BiLogoInstagramAlt className="mr-2"/>
            Instagram
            </a>
            <a href="https://www.facebook.com/Mendriti10" className='flex items-center text-white hover:text-tertiary hover:text-2xl hover:font-semibold mt-2 sm:mb-5' target="_blank">
              <FaFacebookSquare className="mr-2"/>
            Facebook
            </a>
        </div>
        <div className="w-1/2 sm:w-full">
          <p className='text-white text-2xl hidden sm:inline-block sm:mb-5'>Have an exciting project you need help
