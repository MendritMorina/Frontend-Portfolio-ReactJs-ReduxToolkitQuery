...
const Intro = () => {
  ...
  return (
    <div className='h-[75vh] bg-primary flex flex-col items-start justify-center gap-8 py-10'>
      ...
      <button className='border-2 border-tertiary text-tertiary px-10 py-3 rounded transform hover:scale-90 transition duration-300 sm:-mb-32'
